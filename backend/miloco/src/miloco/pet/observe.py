...
{"species":"猫|狗|其他","breed":"<高把握才填，否则空字符串>","size_build":"如 中等体型、体态壮实","coat_color_pattern":"如 黑色 / 橘白双色 / 狸花","coat_length_texture":"如 短毛顺滑 / 长毛蓬松","distinctive_markings":["如 尾尖一撮白","左耳缺口"],"accessories":"<可变动配饰，如项圈颜色；无则空字符串>","summary":"一句规范化外观句，如 中等体型的黑色短毛英短猫，尾巴尖有一撮白毛"}"""
