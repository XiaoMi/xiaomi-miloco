...
（终身只推一次）。此时**由 agent 主动开口**：向用户打招呼、用一两句话说明登记家庭信息的
...
缺口**（宠物年龄/禁忌、作息、设备歧义、方位）追问；作息被跳过就不纠缠，但用户顺带给出的
通知偏好（★）照收；摄像头方位环节 agent **先自己看画面再问**，问题落在具体看到的东西上。
