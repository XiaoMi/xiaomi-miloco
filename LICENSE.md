...
For the avoidance of doubt, any third-party components included in the Licensed Work remain subject to their respective original licenses. Nothing in this License shall restrict or limit your independent use of such third-party components in accordance with their respective original licenses.  
...
为避免疑义，授权作品中包含的任何第三方组件仍受其各自原有许可证的约束。本许可证中的任何内容均不限制或约束您依照该等第三方组件各自原有的许可证对其进行的独立使用。  
