      ...
      >
        ...
        <div className="mt-6 flex justify-end gap-2">
          ...
          <button
            ...
            disabled={busy}
            className="text-body px-4 py-2 rounded-lg bg-error text-text-inverse hover:brightness-95 disabled:opacity-60 disabled:cursor-not-allowed transition-[filter,opacity]"
          >
